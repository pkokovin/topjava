...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo argValidationError(HttpServletRequest req, Exception e) {
        return logAndGetErrorInfo(req, e, true, VALIDATION_ERROR);
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String ... arg) {
        ...
        if (arg.length != 0) {
            return new ErrorInfo(req.getRequestURL(), errorType, arg[0]);
        }
